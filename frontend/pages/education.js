...
export default function EducationPage() {
  return (
    <Layout>
      <Head>
        <title>Digital Security Education - {siteConfig.name}</title>
        <meta name="description" content={`Learn to identify, prevent, and report digital scams with our comprehensive educational resources. Empowering Rwandans with knowledge for digital security and scam prevention with ${siteConfig.name}.`} />
        ...
        <meta property="og:title" content={`Digital Security Education - ${siteConfig.name}`} />
        ...
        <meta name="twitter:title" content={`Digital Security Education - ${siteConfig.name}`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": `${siteConfig.name} - Education`,
