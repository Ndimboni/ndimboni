        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          ...
          >
            <div className="mb-8">
              ...
              <Title level={1} className="text-xl lg:text-2xl font-bold mb-3" style={{ color: '#1A5276' }}>
                Welcome to{' '}
                <span style={{ color: '#2980B9' }}>Ndimboni</span>
              </Title>
              
              <Paragraph className="text-sm mb-3 leading-relaxed max-w-md mx-auto lg:mx-0" style={{ color: '#1A5276' }}>
                {isLogin 
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                >
                  ...
                  <Text className="text-[#1A5276] font-medium text-sm">{feature}</Text>
                </motion.div>
              ))}
            </div>
            ...
            >
              <div className="text-center">
                <div className="text-lg font-bold" style={{ color: '#1A5276' }}>1000+</div>
                <div className="text-xs" style={{ color: '#2980B9' }}>Protected Users</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold" style={{ color: '#1A5276' }}>500+</div>
                <div className="text-xs" style={{ color: '#2980B9' }}>Scams Detected</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold" style={{ color: '#1A5276' }}>24/7</div>
          ...
          >
            ...
            >
              <div className="p-4">
                ...
                >
                  ...
                  {isLogin && (
                    <div className="flex justify-end mb-3">
                      <Button type="link" className="p-0 text-sm text-[#2980B9] hover:text-[#1A5276]">
                        Forgot Password?
                      </Button>
                    </div>
                  )}
                ...
                {/* Security Notice */}
                <div className="mt-4 p-3 rounded-lg" style={{ backgroundColor: '#EBF5FB' }}>
                  <div className="flex items-start">
                    <SecurityScanOutlined className="text-[#2980B9] mt-0.5 mr-2 text-sm" />
                    <div>
                      <Text className="text-xs font-medium block mb-1" style={{ color: '#1A5276' }}>
