  ...
  const reportCards = [
    {
      ...
      description:
        "Verify suspicious messages, emails, or links using our AI-powered detection tool before interacting with them.",
      details:
        "Our intelligent scam detection system analyzes message content, sender information, links, and patterns to help you identify phishing emails, fake text messages, suspicious social media contacts, and fraudulent websites. Get instant feedback on whether a message is legitimate or potentially dangerous.",
    ...
    {
      icon: (
        <ArrowRightOutlined className="text-4xl" style={{ color: "#2980B9" }} />
      ),
      title: "Report a Scam",
      description:
        "Encountered any type of fraudulent activity or suspicious behavior? Use our comprehensive reporting system to document and report various types of scams including online fraud, phone scams, email phishing, and more.",
      details:
        "Our unified reporting platform allows you to quickly submit detailed information about any scam encounter. Provide screenshots, messages, contact details, and incident descriptions to help our team investigate and warn others about emerging threats.",
    ...
    {
      icon: (
        <MessageOutlined className="text-4xl" style={{ color: "#25D366" }} />
      ),
      title: "Report via WhatsApp",
      description:
        "Quickly report scams, fraudulent activities, or suspicious content directly through our WhatsApp channel. Get fast community support and connect with other users who can help verify threats.",
      details:
        "Our WhatsApp reporting system allows you to instantly share suspicious messages, and scam details with our verification team and community. Receive real-time feedback and warnings about emerging scam patterns from other users.",
    ...
    },
    {
      ...
      description:
        "Quickly report scams, fraudulent activities, or suspicious content directly through our Telegram channel. Get fast community support and connect with other users who can help verify threats.",
      details:
        "Our Telegram reporting system allows you to instantly share suspicious messages, and scam details with our verification team and community. Receive real-time feedback and warnings about emerging scam patterns from other users.",
    ...
    {
      icon: (
        <SearchOutlined className="text-4xl" style={{ color: "#2980b9" }} />
      ),
      title: "Check Scammer",
      description:
        "Verify if someone contacting you is a known scammer or fraudster. Search our database of reported scammers using phone numbers, email addresses, usernames, or other identifying information.",
      details:
        "Our scammer verification system maintains a comprehensive database of known fraudsters and their contact methods. Check suspicious profiles, phone numbers, and accounts before engaging to protect yourself from potential scams.",
        ...
        <section className="bg-white text-dark py-4">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <Paragraph
                className="text-lg mb-8 leading-relaxed max-w-4xl mx-auto"
                style={{ color: "#1A5276" }}
              >
                Help protect the Rwandan digital community by reporting scams
                and fraudulent activities. Your reports help us improve our AI
                detection systems and warn others about emerging threats. All
                reports are handled confidentially and contribute to building a
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <Paragraph
                ...
                style={{ color: "#1A5276" }}
              >
                Select the type of scam or fraudulent activity you want to
                report. Each category helps us better understand and combat
                specific threats.
              </Paragraph>
            </motion.div>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <Paragraph
                ...
                style={{ color: "#1A5276" }}
              >
                If you're currently being targeted by a scam or have already
                been victimized, contact the authorities immediately or reach
                out to our emergency support channels.
              </Paragraph>
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${
                      checkResult.status === CheckStatus.SAFE
                        ...
                        ? "#fff3cd"
                        : checkResult.status === CheckStatus.MALICIOUS
                        ? "#f8d7da"
                        : "#e2e3e5"
                    }, #ffffff)`,
                  }}
                ...
                <div className="p-4 space-y-3">
                  ...
                  {checkResult.warning_flags?.length > 0 && (
                    <div className="p-3 bg-orange-50 rounded-lg">
                      <Text
                        strong
                        className="text-sm text-orange-800 block mb-2"
                      >
                        Warning Flags ({checkResult.warning_flags.length})
                      </Text>
                      <div className="space-y-1">
                        {checkResult.warning_flags
                          .slice(0, 3)
                          .map((flag, index) => (
                            <div
                              key={index}
                  ...
                  {checkResult.recommendations?.length > 0 && (
                    <div className="p-3 bg-green-50 rounded-lg">
                      <Text
                        strong
                        className="text-sm text-green-800 block mb-2"
                      >
                        Recommendations
                      </Text>
                      <div className="space-y-1">
                        ...
                        {checkResult.recommendations.length > 2 && (
                          <Text className="text-xs text-gray-600">
                            +{checkResult.recommendations.length - 2} more
                            recommendations...
                          </Text>
                        )}
                      </div>
