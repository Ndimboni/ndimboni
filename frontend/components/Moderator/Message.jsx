...
const ContactMessagesPage = () => {
  ...
  }, [pagination.current, pagination.pageSize, filters, isAuthorized, isClient, authChecked]);
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5', padding: window.innerWidth <= 768 ? '12px' : '24px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: window.innerWidth <= 768 ? '16px' : '32px' }}>
          <div style={{ 
            ...
            <div>
              <Title level={window.innerWidth <= 768 ? 3 : 2} style={{ marginBottom: '8px' }}>
            ...
            <Col xs={12} sm={12} md={6} lg={6}>
              <Card size="small">
                <Statistic
                  ...
                  valueStyle={{ color: '#1890ff', fontSize: window.innerWidth <= 768 ? '18px' : '24px' }}
                />
              </Card>
            </Col>
            <Col xs={12} sm={12} md={6} lg={6}>
              <Card size="small">
                <Statistic
                  ...
                  valueStyle={{ color: '#faad14', fontSize: window.innerWidth <= 768 ? '18px' : '24px' }}
                />
              </Card>
            </Col>
            <Col xs={12} sm={12} md={6} lg={6}>
            ...
            <Col xs={12} sm={12} md={6} lg={6}>
              <Card size="small">
                <Statistic
                  ...
                  valueStyle={{ color: '#52c41a', fontSize: window.innerWidth <= 768 ? '18px' : '24px' }}
                />
              </Card>
            </Col>
          </Row>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {selectedContact.adminResponse && (
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div style={{ marginTop: '8px', padding: '12px', backgroundColor: '#e6f7ff', borderRadius: '4px' }}>
        ...
        <Modal
          ...
          onOk={() => {
            ...
            const values = {
              ...
              ...(responseTextarea?.value && { adminResponse: responseTextarea.value })
            };
